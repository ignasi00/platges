...
class KfoldsLocalLogger():
    ...
    def finish_fold(self):
        ...
        self.v_best_train.append(train_local_logger.get_one_epoch_log(best_epoch, prefix=f"train_"))
        self.v_best_valid.append(val_local_logger.get_one_epoch_log(best_epoch, prefix=f"valid_"))
